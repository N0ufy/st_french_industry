...
st.write("""Les données E14TST relatent le nombre d\'entreprises par commune. Ces données ont été divisés par quartiles (0.25, 0.50, 0.75) pour la colorimétrie.""") 
